/* 10.12.4 */ ! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).Sweetalert2 = e() }(this, function() { "use strict";
    ...
    function dt(t, e) { var e = 1 < arguments.length && void 0 !== e && e,
            n = V();
    ...
    function Ve(t, e, n) { var o = N(); if (o.length) return (e += n) === o.length ? e = 0 : -1 === e && (e = o.length - 1), o[e].focus();
        ...
        gn = function(t) { for (var e = t.target, n = N(), o = -1, i = 0; i < n.length; i++)
                if (e === n[i]) { o = i; break }
    ...
    s(In.prototype, J), s(In, pe), Object.keys(J).forEach(function(t) { In[t] = function() { if (Dn) return Dn[t].apply(Dn, arguments) } }), In.DismissReason = Q, In.version = "10.12.4"; var Mn = In; return Mn.default = Mn }), void 0 !== this && this.Sweetalert2 && (this.swal = this.sweetAlert = this.Swal = this.SweetAlert = this.Sweetalert2);
