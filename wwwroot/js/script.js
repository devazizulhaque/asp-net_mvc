...
$(document).ready(function() {
    ...
    '<img class="img-fliud" src="assets/backend/images/theme/layout-ltr.png" alt="layout">' +
    '</div>' +
    '</div>' +
    '</div>' +
    '<div class="col-xl-6 ere">' +
    ...
    '</div>' +
    '<div class="layout-img">' +
    '<img class="img-fliud" src="assets/backend/images/theme/layout-rtl.png" alt="layout">' +
    '</div>' +
    '</div>' +
    '</div>' +
    '</div>' +
    ...
    '</div>' +
    '<div class="layout-img">' +
    '<img class="img-fliud" src="assets/backend/images/theme/layout-04.png" alt="layout">' +
    '</div>' +
    '</div>' +
    '</div>' +
    '<div class="col-xl-6 ere">' +
    ...
    '</div>' +
    '<div class="layout-img">' +
    '<img class="img-fliud" src="assets/backend/images/theme/layout-01.png" alt="layout">' +
    '</div>' +
    '</div>' +
    '</div>' +
    '</div>' +
    ...
    '</div>' +
    '<div class="layout-img">' +
    '<img class="img-fliud" src="assets/backend/images/theme/layout-03.png" alt="layout">' +
    '</div>' +
    '</div>' +
    '</div>' +
    '<div class="col-xl-6 ere">' +
